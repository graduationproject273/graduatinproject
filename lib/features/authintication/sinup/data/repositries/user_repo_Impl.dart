  ...
  try {
    final response = await dioConsumer.post(
      ...
      data: SellerModel(
        ...
        addresses: seller.addresses.map((e) => AddressModel(
          street: e.street,
          city: e.city,
          state: e.state,
          zip: e.zip,
      ...
      (r) {
        try {
          ...
          if (raw is String && raw.trim().isEmpty) {
            ...
            return Left(Failure(errMessage: "Empty response string from server"));
          }
          ...
          // ✅ نوع غير متوقع
            ...
            return Left(Failure(errMessage: "Unexpected response format: ${raw.runtimeType}"));
          }
