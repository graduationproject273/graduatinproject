        ...
        child: Column(
          children: [
            ...
            CustomButton(
              ...
              onTap: () {
                final email =
                    context.read<SinupCubit>().emailController.text.trim();
                final password =
                    context.read<SinupCubit>().passwordController.text;
                ...
                if (context.read<SinupCubit>().formkey.currentState!
                    .validate()) {
                  context.read<SinupCubit>().signup(
